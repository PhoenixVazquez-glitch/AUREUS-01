import fs from 'fs';
import type { ResponseLike } from 'aureus-stainless/internal/to-file';
import { toFile } from 'aureus-stainless/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('aureus-stainless/core/uploads');
    await expect(
